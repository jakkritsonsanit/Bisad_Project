...
<?php
	if (isset($_POST['shopname'])) {
		...
		$query_shop_id = mysqli_query($conn, "SELECT shop_id FROM shop WHERE name = '$shopname'") or die (mysqli_error($conn));
		$_SESSION['shop_id'] = mysqli_fetch_assoc($query_shop_id)['shop_id'];
